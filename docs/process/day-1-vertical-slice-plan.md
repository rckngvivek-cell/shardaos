...
2. Root `.env.example` documents the current mock and emulator-backed runtime flags.
...
1. `GET /api/v1/health`
2. `GET /api/v1/schools/:schoolId`
3. `GET /api/v1/schools/:schoolId/students`
4. `POST /api/v1/schools/:schoolId/students`
...
2. Student list and create endpoints work with mock or emulator-backed storage.
